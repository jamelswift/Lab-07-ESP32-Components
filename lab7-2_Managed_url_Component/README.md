...
Ans ความแตกต่างจาก Lab 7-1

Lab 7-1: ใช้ Local Component (อยู่ในโฟลเดอร์ components/ ของโปรเจกต์)

Lab 7-2: ใช้ Managed Component (ดึงอัตโนมัติจาก GitHub URL ผ่าน idf_component.yml)
